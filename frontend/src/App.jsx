...
export default function App() {
  return <ConfigProvider locale={zhCN} theme={{ token: { colorPrimary: '#3f6f73', borderRadius: 10, colorText: '#31404a', fontFamily: 'Inter, Microsoft YaHei, sans-serif' } }}><AuthProvider><BrowserRouter><Routes>
